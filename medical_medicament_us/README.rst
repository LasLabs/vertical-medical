...
Medical Medicament US
=====================

Extension of medical_medicament that provides US Locale 
...
`here <https://github.com/OCA/vertical-medical/issues/new?body=module:%20medical_medicament_us%0Aversion:%209.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
