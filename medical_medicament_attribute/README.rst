...
* Note that versions > 8.0.1.0.0 are not compatible with previous versions. No migrations are provided
...
`here <https://github.com/OCA/vertical-medical/issues/new?body=module:%20medical_medicament_attributes%0Aversion:%209.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
